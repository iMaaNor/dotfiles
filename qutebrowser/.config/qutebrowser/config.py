...
config.bind(',fs', 'set content.proxy socks://127.0.0.1:1088 ;; spawn notify-send "Proxy set to SHADOWSOCKS"')
config.bind(',dd', 'hint links spawn tsocks kitty -e youtube-dl {hint-url} ;; spawn notify-send "Download Has Been Started"')
config.bind(',ds', 'hint links spawn tsocks kitty -e youtube-dl --write-auto-sub --sub-lang en {hint-url} ;; spawn notify-send "Download Has Been Started"')
config.bind(',DD', 'spawn tsocks kitty -e youtube-dl {url} ;; spawn notify-send "Download Has Been Started"')
config.bind(',DS', 'spawn tsocks kitty -e youtube-dl --write-auto-sub --sub-lang en {url} ;; spawn notify-send "Download Has Been Started"')
