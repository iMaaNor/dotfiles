...
config.bind(',dd', 'hint links spawn alacritty -e youtube-dl {hint-url} ;; spawn notify-send "Download Has Been Started"')
config.bind(',ds', 'hint links spawn alacritty -e youtube-dl --write-auto-sub --sub-lang en {hint-url} ;; spawn notify-send "Download Has Been Started"')
config.bind(',DD', 'spawn alacritty -e youtube-dl {url} ;; spawn notify-send "Download Has Been Started"')
config.bind(',DS', 'spawn alacritty -e youtube-dl --write-auto-sub --sub-lang en {url} ;; spawn notify-send "Download Has Been Started"')
